...
<body>
        ...
        <img src='https://www.prepsportswear.com/media/images/college_logos/300x300/2126241_mktg_logo.png' class='avatar'>
                ...
                <h1><center>Login</center></h1>
                        ...
                        <p class="message"><a href='http://elvis.rowan.edu/~sharifs3/SeniorProject/Register.php'>Sign up for an account<br><br></a></p>
                                ...
                                if($password == $dbpass){
                                        if($dbactive == 1){
                                                ...
                                                $dbrole = $row[roleID];
                                                        ...
                                                        if($dbrole == 1){
                                                                header('Location: http://elvis.rowan.edu/~sharifs3/SeniorProject/admindashboard.php');
                                                                }
                                                        else if($dbrole ==2){

                                                header('Location: http://elvis.rowan.edu/~sharifs3/SeniorProject/dashboard.php');
                                                                        }
                                                exit();
