...
if(isset($_GET["timesheetsid"])){
	...
	if($result){
		...
		echo "test after setting day vals. Sunday1 = " . $sunday1 . " Monday1= " . $monday1 . 
		" Sunday2= " . $sunday2 . " Monday2= " . $monday2;
	}else
...
if($_POST['submit']){
        ...
        $insert .= "('40', 'Pending', '$todaysdate', '$sunday1', '$monday1', '$tuesday1', '$wednesday1', '$thursday1', '$friday1', '$saturday1', ";
				...
				if($bannerresult){
					...
					if($idresult){
						...
						if($insertstutimesheets){
							...
							echo "Studenttimesheets insert query failed. Error: " . mysqli_error($dbh);
						}
