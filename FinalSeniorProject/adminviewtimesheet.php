...
if(isset($_GET["timesheetsid"])){
        ...
        $query = "SELECT * FROM timesheets WHERE timesheetsid = $timesheetsid";
...
<form name="Timesheet" method="post" action="./adminreporting.php">
<div class="heading">
  </div>
<center>
<fieldset>
...
<td align="center" width="38"><input type="number" name="Monday" size="1" maxlength="1" value="<?php echo $monday1 ?>"
 onkeypress="return inputLimiter(event,'Numbers')"  onblur="calc()" min="0" max="8" readonly>
</td>
...
<td align="center" width="100"><input class="right" type="number" name="Total" readonly="readonly" size="5" value="<?php echo $total_hours ?>">
</td>
</tr>
</table>
</fieldset>
...
<form action="adminreporting.php">
    <input type="submit" value="View all timesheets"/>
</form>
